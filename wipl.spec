...
Program wipl potrafi prowadzić i wyświetlać statystyki bazując na
pakietach zauważonych przez kartę sieciową.

Pakiet zawiera demona, który prowadzi statystyki. Dla każdego pakietu
zauważonego przez kartę sieciową demon wykonuje mały program wskazany
przez użytkownika. Program ten może uaktualniać statystyki używając
informacji o pakiecie. Musi być napisany w bardzo prostym, wbudowanym
języku programowania.

Pakiet zawiera także kilka programów klienckich, które mogą odczytywać
lub modyfikować statystyki prowadzone przez demona. Te tabele mogą być
zapisane do plików HTML lub XML, co pozwala na łatwą publikację na
stronach WWW.

Na stronie projektu wipl dostępne jest rozszerzenie pozwalające
programowi współpracować z serwerami proxy takimi jak Squid i socks5.
